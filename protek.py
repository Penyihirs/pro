...
ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EqAZ5qA4qp6S4rLVNnV7.w7PintyRt9WjtuWkjx6InW.xx9JjV5xmTdmP971/q4VdX1YP1ofjLAIIKpCCRHPk0U=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='EqT2X8jLTzSpWoTys159.5RaliWBlzSi7P4maDE0AYq.danZN1znyU3r5iKKPE5twgScxbXTGQzuCz0KUHFYCPk=')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='EqML531ZwiMUjuGpkMHa.UML/F5OMmCzegj+kXFSa6G.CHJzcoQ3WwKbXalNWAN73ZhggsKwMgJzLVDciVScbyg=')
kc.loginResult()
...
#vipro.login(qr=True)
vipro.login(token='EqML531ZwiMUjuGpkMHa.UML/F5OMmCzegj+kXFSa6G.CHJzcoQ3WwKbXalNWAN73ZhggsKwMgJzLVDciVScbyg=')
vipro.loginResult()
print "Vipro-Login Success\n"

km = LINETCR.LINE() #(bot ini di luar grup fungsinya jadi algojo kaya kicker siri)
#km.login(qr=True)
km.login(token='EqT2X8jLTzSpWoTys159.5RaliWBlzSi7P4maDE0AYq.danZN1znyU3r5iKKPE5twgScxbXTGQzuCz0KUHFYCPk=')
km.loginResult()
              ...
              if msg.from_ in Creator:
                ...
                try:
					...
					for song in data:
						...
						cl.sendText(msg.to, "ʟᴀɢᴜ " + song[0] + "\nsᴇᴅᴀɴɢ ᴅɪʙᴘʀᴏsᴇs...sᴇʙᴇɴᴛᴀʀ ʏᴀ 😉😉 ")
						cl.sendAudioWithURL(msg.to,abc)
						cl.sendText(msg.to, "♪sᴇʟᴀᴍᴀᴛ ᴍᴇɴᴅᴇɴɢᴀʀᴋᴀɴ ᴍᴜsɪᴋ ɴʏᴀ ᴋᴀᴡᴀɴ♪\n♫ʟᴇᴛs ᴘʟᴀʏ sᴏɴɢ " + song[0])
                ...
                try:
					...
					for song in data:
						...
						cl.sendAudioWithURL(msg.to,abc)
						cl.sendText(msg.to, "Title : " + song[0] + "\nLength : " + song[1] + "\nLink download : " + song[4] +"\n\n" + hasil)
						cl.sendText(msg.to, "♪ɴɪᴋᴍᴀᴛɪ ᴍᴜsɪᴋ ɴʏᴀ ᴋᴀᴡᴀɴ♪\n♫ʟᴇᴛs ᴘʟᴀʏ sᴏɴɢ " + song[0])
