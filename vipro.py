...
vipro = LINETCR.LINE()
#vipro.login(qr=True)
vipro.login(token='Eqw2kPNTAJmi1AA36pJf.elYFTRZfqLa1zXCZwiMgtW.ZQ4br6QN9YAZFTDSxUP5doLQdG6Ui8mkYmGXDHHF6nw=')
vipro.loginResult()
...
#                            Name = summon(op.param2)
		...
		if wait["detectMention1"] == True: md+="╠➩✔️ Auto Respon1 : On\n"
